...
from data_cleaning.icp import icp
...
from data_cleaning.visualize_functions import visualize_vicon_points, visualize_2d_points_on_frame
...
class TestKabsch(unittest.TestCase):
    ...
    # Find transformation.
    T, distances, iterations = icp(B=B, A=A, tolerance=0.000001)
